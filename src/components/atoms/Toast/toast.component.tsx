...
function ToastComponent(props: any) {
  ...
  useEffect(() => {
    ...
    const pendingConfigObj = {
      render() {
        const pending = props.promisePending
    ...
    const successConfigObj = {
      render() {
        const success = props.promiseSuccess
          ? props.promiseSuccess
          : () => {
              return 'Success';
            };
        return success();
    ...
    const errorConfigObj = {
      render() {
        const error = props.promiseError
          ? props.promiseError
          : () => {
              return 'Error';
            };
  ...
  return (
    <ToastContainer
      toastClassName={props.toastContainer}
      bodyClassName={props.toastBody}
